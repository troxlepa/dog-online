...
import { computeRandomState, makeHands } from "../util";
// import { computeStateTwo } from "../lib";
...
function GamePage({ user, gameId }) {
  ...
  function getStepContent(stepIndex) {
    switch (stepIndex) {
      case 0:
        return <><img className={classes.helpImage} alt="" src={Help1} /><Typography component={'span'} className={classes.helpText}>{(t("step0"))}</Typography></>;
      case 1:
        return <><img className={classes.helpImage} alt="" src={Help2} /><Typography component={'span'} className={classes.helpText}>{(t("step1"))}</Typography></>;
      case 2:
        return  <><img className={classes.helpImage} alt="" src={Help3} /><Typography component={'span'} className={classes.helpText}>{(t("step2"))}</Typography></>;
      case 3:
        return  <><img className={classes.helpImage} alt="" src={Help4} /><Typography component={'span'} className={classes.helpText}>{(t("step3"))}</Typography></>;
      case 4:
        return  <><img className={classes.helpImage} alt="" src={Help6} /><Typography component={'span'} className={classes.helpText}>{(t("step5"))}</Typography></>;
      case 5:
