...
import ***REMOVED*** useEffect, useState, useCallback***REMOVED*** from "react";
import ***REMOVED*** useTranslation ***REMOVED*** from 'react-i18next';
import ***REMOVED*** getEmptyHomeField, isMyBall, isHomeField, isMyFinish, isPartnerBall, iHaveFinished, getLastField ***REMOVED*** from "../util";
...
function Balls(***REMOVED***gameBalls, selected, setSelected, turn, lastFour, orderMyPosition, activeCard, spectating,gameRooted, gameRules, setSnack***REMOVED***)***REMOVED***
  const settings = ***REMOVED***canadian:true***REMOVED***;
  ...
  const animatedBalls=prevSel.filter(function(element, index, array) ***REMOVED*** return (index % 2 === 1);***REMOVED***);
  const allFields = [...Array(96).keys()];
  const currentPlayerBalls = gameBalls.slice(turn*4,(turn*4)+4);
 

  function ballFinishSeven(field,selected,orderMyPosition,gameBalls,canadian)***REMOVED***
...
***REMOVED***
  function moveSeven(field,selected,orderMyPosition,gameBalls,canadian)***REMOVED***
    ...
    setSelected(selected => ***REMOVED***
      ...
      switch(aC)***REMOVED***
        ...
        case '7':
          ...
          const evalBalls = [...gameBalls].map((el,ix) => ***REMOVED***if(selected.indexOf(el) % 2 == 0)***REMOVED***return selected[selected.indexOf(el)+1]***REMOVED***return el;***REMOVED***);
...
***REMOVED***
  ...
  function finishOverhop(field, evalBalls)***REMOVED***
...
***REMOVED***
  ...
  function cutOverflow(field)***REMOVED***
...
***REMOVED***
  ...
  function calcIncrease(start,dest)***REMOVED***
    if(start > 56 && dest < 7)***REMOVED***
        ...
        ***REMOVED******REMOVED***
                  >
                    ***REMOVED***value => ***REMOVED***
                      ...
                      return <SvgProxy transform=***REMOVED***tr***REMOVED*** key =***REMOVED***"b"+ix***REMOVED*** selector=***REMOVED***setBall(ix)***REMOVED*** onClick=***REMOVED***(node) => ***REMOVED***handleClick(field,true)***REMOVED******REMOVED*** class=***REMOVED***"ball "+(selected.includes(field)?"active active"+Math.floor(selected.lastIndexOf(field)/2):"")+" "+setColor(ix)+" "+(currentPlayerBalls.includes(field)?"pulsing":"")***REMOVED*** />; //***REMOVED***setColor(ix)***REMOVED***  ***REMOVED***setStone(ball)***REMOVED***
        ***REMOVED******REMOVED***
                  </Motion>
                  ) : (
                    <SvgProxy key=***REMOVED***"b"+ix***REMOVED*** transform=***REMOVED***`translate($***REMOVED***COORDS[field][0]***REMOVED***,$***REMOVED***COORDS[field][1]***REMOVED***)`***REMOVED*** selector=***REMOVED***setBall(gameBalls.indexOf(field))***REMOVED*** onClick=***REMOVED***(node) => ***REMOVED***handleClick(field,true)***REMOVED******REMOVED*** class=***REMOVED***"ball "+(selected.includes(field)?"active active"+Math.floor(selected.lastIndexOf(field)/2):"")+" "+setColor(ix)+" "+(currentPlayerBalls.includes(field)?"pulsing":"")***REMOVED*** /> //***REMOVED***setColor(ix)***REMOVED***  ***REMOVED***setStone(ball)***REMOVED***
                /*);*/
